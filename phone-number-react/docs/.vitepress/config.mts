...
export default defineConfig({
  ...
  description:
    'Headless React hook (usePhoneNumber) for country phone inputs. Auto formatting, dial codes, mask patterns, digit normalization, and validation with zero dependencies.',
  cleanUrls: false,
  lastUpdated: true,
  sitemap: {
    hostname: siteOrigin,
    ...
    return [
      ...
      [
        ...
        JSON.stringify({
          ...
          downloadUrl: 'https://www.npmjs.com/package/@erag/phone-number-react',
