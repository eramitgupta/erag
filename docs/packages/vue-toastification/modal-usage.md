...
description: Learn how to use promise-based confirmation modals in Vue 3 with @erag/vue-toastification. Perfect for delete, logout, and critical actions.
keywords:
...
With **@erag/vue-toastification**, modals are designed to be:
...
## 🗑️ Real-World Example: Delete Action
...
### 🔵 `info` — Neutral Confirmations (Default)
