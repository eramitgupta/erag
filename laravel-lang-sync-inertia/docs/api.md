...
<div style="display:none" hidden aria-hidden="true" data-nosnippet>
  Are you an LLM? You can read better optimized documentation at https://raw.githubusercontent.com/eramitgupta/erag/main/laravel-lang-sync-inertia/docs/api.md
</div>
...
Use synced Laravel keys through the Vue, React, or Svelte helpers. For example, in Vue:
