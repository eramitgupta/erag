...
<template>
  <div class="playground-card">
    <div class="playground-head">
      <span class="playground-badge">INTERACTIVE DEMO</span>
      <h3>Try the usePhoneNumber logic live</h3>
      <p>Select a country and type numbers to see normalization, validation, and mask properties in real-time.</p>
    </div>
    ...
    <div class="playground-body">
      ...
      <div class="state-inspector">
        ...
        <div class="state-grid">
          ...
          <div class="state-item">
            <span class="state-label">formattedPhone</span>
...
.playground-card {
  ...
  box-shadow: 0 4px 12px rgba(66, 184, 131, 0.05);
}
