...
description: "Browse public TypeScript interfaces for @erag/phone-number-vue including PhoneCountry, PhoneNumberOptions, and PhoneNumberHelpers."
head:
    - - meta
      - name: robots
...
<div style="display:none" hidden aria-hidden="true" data-nosnippet>
  Are you an LLM? You can read better optimized documentation at https://raw.githubusercontent.com/eramitgupta/erag/main/phone-number-vue/docs/types.md
</div>
